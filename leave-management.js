(function leaveManagementBootstrap() {
  ...
  function getSelectedCompanyScope() {
    ...
    return String(localStorage.getItem("adminSelectedCompanyScope") || "").trim();
  }
      ...
      <div class="leave-shell admin-mode">
        <div class="leave-hero">
          <div>
            ...
            <p>Review requests across TME, Email Marketing, ME, DEV, SEO and SMO teams, filter live records, and approve or reject requests without reloading the CRM.</p>
          </div>
          <div class="leave-hero-actions">
